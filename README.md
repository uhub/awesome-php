...
* [jsonrainbow/json-schema](https://github.com/jsonrainbow/json-schema) - PHP implementation of JSON schema. Fork of the http://jsonschemaphpv.sourceforge.net/ project
