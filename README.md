...
* [fossar/selfoss](https://github.com/fossar/selfoss) - selfoss: The multipurpose rss reader, live stream, mashup, aggregation web application
...
* [tighten/takeout](https://github.com/tighten/takeout) - Docker-based development-only dependency manager. macOS-only and installs via PHP's Composer... for now.
