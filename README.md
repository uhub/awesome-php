...
* [ramsey/uuid](https://github.com/ramsey/uuid) - A PHP library for generating RFC 4122 version 1, 2, 3, 4, and 5 universally unique identifiers (UUID).
...
* [apiato/apiato](https://github.com/apiato/apiato) - API framework. (Built with PHP on top of Laravel)
...
* [thephpleague/commonmark](https://github.com/thephpleague/commonmark) - Highly-extensible PHP Markdown parser which fully supports the CommonMark spec.
...
* [kreait/firebase-php](https://github.com/kreait/firebase-php) - Firebase Admin SDK for PHP
...
* [leocavalcante/siler](https://github.com/leocavalcante/siler) - :zap: Flat-files and plain-old PHP functions rockin'on as a set of general purpose high-level abstractions.
...
* [TypiCMS/Base](https://github.com/TypiCMS/Base) - Multilingual and modular CMS built with Laravel 6
...
* [Behat/Gherkin](https://github.com/Behat/Gherkin) - Gherkin parser, written in PHP 5.3+ for Behat project
...
* [Jean85/pretty-package-versions](https://github.com/Jean85/pretty-package-versions) - A wrapper for ocramius/package-versions to get pretty versions strings
...
* [dedemao/alipay](https://github.com/dedemao/alipay) - 一个PHP文件搞定支付宝支付系列，包括电脑网站支付，手机网站支付，现金红包、扫码支付，JSAPI支付、单笔转账到支付宝账户、交易结算（分账、分润）、网页授权获取用户信息等
...
* [sulu/sulu-standard](https://github.com/sulu/sulu-standard) - This repository is not longer the recommended way to start a sulu project. Use:
* [ovr/phpsa](https://github.com/ovr/phpsa) - Smart/Static Analyzer(sis) for PHP :bowtie::neckbeard:
* [kevinpapst/kimai2](https://github.com/kevinpapst/kimai2) - Kimai v2 is a web-based multiuser time-tracking application. Free for everyone: freelancers, agencies and companies track their employee working-times and generate invoices.
...
* [atymic/twitter](https://github.com/atymic/twitter) - Twitter API for Laravel 5.5+ & 6.x
...
* [YouPHPTube/YouPHPTube](https://github.com/YouPHPTube/YouPHPTube) - The Best YouTube Clone Script
...
* [tacnoman/dephpugger](https://github.com/tacnoman/dephpugger) - Dephpugger is a debug with breakpoints to run in terminal
...
* [30-seconds/30-seconds-of-php-code](https://github.com/30-seconds/30-seconds-of-php-code) - A curated collection of useful PHP snippets that you can understand in 30 seconds or less.
...
* [mix-php/mix](https://github.com/mix-php/mix) - ☄️Mix PHP — 基于 Swoole 的 FastCGI、常驻内存、协程三模 PHP 高性能框架 (开发文档完善)
* [legalthings/sso](https://github.com/legalthings/sso) - Jasny\SSO - Simple Single Sign-On for PHP
* [HDInnovations/UNIT3D](https://github.com/HDInnovations/UNIT3D) - :rocket: A Next Generation Private Torrent Tracker
...
* [kimai/kimai](https://github.com/kimai/kimai) - Kimai v1 open source time-tracking - please switch to Kimai v2 (this repository is not maintained any longer)
...
* [Microsoft/msphpsql](https://github.com/Microsoft/msphpsql) - Microsoft Drivers for PHP for SQL Server
* [m9rco/arithmetic-php](https://github.com/m9rco/arithmetic-php) - 🍭🍭uniting the internal work in a way that is in PHP
* [Microsoft/tolerant-php-parser](https://github.com/Microsoft/tolerant-php-parser) - An early-stage PHP parser designed for IDE usage scenarios.
...
* [symfony/polyfill-apcu](https://github.com/symfony/polyfill-apcu) - This component provides apcu_* functions and the APCUIterator class to users of the legacy APC extension.
...
* [mixstart/mixphp](https://github.com/mixstart/mixphp) - ☄️ 基于 Swoole 的FPM、常驻内存、协程三模 PHP 高性能框架 (开发文档完善)
...
* [slimkit/thinksns-plus](https://github.com/slimkit/thinksns-plus) - 一个强大的社交系统
